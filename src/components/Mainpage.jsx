                ...
                <div className="bg-green-500 text-black py-12">
                    <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center px-6">
                        <div>
                            ...
                            <p className="mt-2 font-bold text-sm">Step 1: Click on the Create Blog Button to create your first Blog</p>
                        </div>
                        <div>
                            <h2 className="text-2xl font-bold">Build Your Own Blog</h2>
                            <p className="mt-2 text-sm font-bold">Step-2: Now Click on the My Blogs section to view your Blog</p>
                        </div>
                        <div>
                            <h2 className="text-2xl font-bold">Earn Knowledge by Referring</h2>
                            <p className="mt-2 font-bold text-sm">Step 3: You can Create,Edit and Delete your Blogs  Note: That featured blogs are static only you can click them to redirect My Blogs</p>
                        </div>
                    </div>
                </div>
            </div>
