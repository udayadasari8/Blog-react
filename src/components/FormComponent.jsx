...
const FormComponent = ({ isOpen, onClose, onSubmit, blogToEdit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    Swal.fire({
      title: "Submitted!",
      text: blogToEdit ? "You edited your Blog!" : "You created your Blog!",
      icon: "success"
    });
  };
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-green-400 p-20 w-230 h-200 rounded shadow-lg">
        <h2 className="text-3xl font-bold mb-4 ">{blogToEdit ? 'Edit Blog' : 'Create New Blog'}</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full p-4 my-4 border border-black rounded"
              required
            />
          </div>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full p-4 my-2 border border-black rounded"
              required
            />
          </div>
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full p-8 my-2 border border-black rounded"
              required
            ></textarea>
          </div>
          <div className="mb-6">
